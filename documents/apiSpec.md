...
POST /login の項を参照のこと。ログインに成功するとレスポンスのjsonの中身としてキーが取得できる。
...
リクエスト/レスポンスのbodyは特記がなければ原則jsonで行う
...
DELETE /authed/invitations/:id?agreement=true
